...
@include('cms.cms_header', ['title' => 'Categories'])
<div class="row">
    <div class="col">
        <a class="btn btn-primary" href="{{url('cms/categories/create')}}">Add Category
    ...
    <div class="col">
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                ...
                <tr>
                    <td><img src="{{asset('storage/images/' . $item['cimage'])}}"
                            style="width: 60px; border-radius: 5px" alt="{{$item['ctitle']}}">
                    </td>
                    <td>{{$item['ctitle']}}</td>
                    <td>
                        <a href="{{url('cms/categories/' . $item['id'] . '/edit')}}">Edit
                            <x-heroicon-o-pencil class="x-icon" />
                        </a>
                        <button data-toggle="modal" data-target="#deleteLink"
                            data-url="{{ url('cms/categories/'. $item['id'])}}" data-title="{{$item['ctitle']}}"
