...
@include('cms.cms_header', ['title' => 'Content'])
<div class="row">
    <div class="col">
        <a class="btn btn-primary" href="{{url('cms/content/create')}}">Add Content Link
        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @endforeach
                    <td>
                        <a href="{{url('cms/content/' . $item['id'] . '/edit')}}">Edit
                            <x-heroicon-o-pencil class="x-icon" />
                        </a>
                        <button data-toggle="modal" data-target="#deleteLink"
                            data-url="{{ url('cms/content/'. $item['id'])}}" data-title="{{$item['ctitle']}}"
